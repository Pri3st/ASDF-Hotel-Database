...
CREATE TABLE `Access` (
  ...
  CONSTRAINT `Access_ibfk_1` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `Access_ibfk_2` FOREIGN KEY (`space_id`) REFERENCES `Space` (`space_id`) ON DELETE NO ACTION ON UPDATE CASCADE
...
CREATE TABLE `Charge` (
  ...
  KEY `nfc_id` (`nfc_id`),
  CONSTRAINT `Charge_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `Service` (`service_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `Charge_ibfk_2` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Subscribe` (
  ...
  CONSTRAINT `Subscribe_ibfk_2` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `Subscribe_ibfk_3` FOREIGN KEY (`subscr_id`) REFERENCES `Subscription` (`subscr_id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `Visit` (
  ...
  KEY `nfc_id` (`nfc_id`),
  KEY `space_id` (`space_id`),
  CONSTRAINT `Visit_ibfk_1` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
  CONSTRAINT `Visit_ibfk_2` FOREIGN KEY (`space_id`) REFERENCES `Space` (`space_id`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`sqlpri3st`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ServicesbyTypeView` AS select `Customer`.`nfc_id` AS `nfc_id`,`Service`.`service_descr` AS `service_descr`,`Service`.`service_id` AS `service_id` from ((`Customer` join `Service`) join `Receive`) where `Customer`.`nfc_id` = `Receive`.`nfc_id` and `Receive`.`service_id` = `Service`.`service_id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-06-15 14:13:06
