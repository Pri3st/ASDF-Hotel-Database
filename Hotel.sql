...
--
-- Host: localhost
-- Generation Time: Jun 10, 2021 at 10:53 AM
...
(2, 'Ogmundur', 'Kristinsson', '1989-06-19', 744362, 'Identity Card', 'Republic of Iceland'),
(3, 'Konstantinos', 'Tzolakis', '2002-11-08', 826570, 'Identity Card', 'Hellenic Republic'),
(4, 'Ruben', 'Semedo', '1994-04-04', 119787, 'Identity Card', 'Portuguese Republic'),
...
(8, 'Oleg', 'Reabciuk', '1998-01-16', 166411, 'Identity Card', 'Republic of Moldova'),
(9, 'Kenny', 'Lala', '1999-10-03', 499268, 'Identity Card', 'French Republic'),
(10, 'Mady', 'Camara', '1997-02-28', 164378, 'Passport', 'Republic of Guinea'),
...
(19, 'Youssef', 'El Arabi', '1987-02-03', 17906, 'Green Card', 'Republic of Morocco'),
...
--
ALTER TABLE `Access`
  ADD CONSTRAINT `Access_ibfk_1` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Access_ibfk_2` FOREIGN KEY (`space_id`) REFERENCES `Space` (`space_id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `Charge`
--
ALTER TABLE `Charge`
  ADD CONSTRAINT `Charge_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `Service` (`service_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Charge_ibfk_2` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `Subscribe`
  ADD CONSTRAINT `Subscribe_ibfk_2` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Subscribe_ibfk_3` FOREIGN KEY (`subscr_id`) REFERENCES `Subscription` (`subscr_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `Visit`
  ADD CONSTRAINT `Visit_ibfk_1` FOREIGN KEY (`nfc_id`) REFERENCES `Customer` (`nfc_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `Visit_ibfk_2` FOREIGN KEY (`space_id`) REFERENCES `Space` (`space_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
