...
<html>
<body bgcolor="1c1d26">
<a href="mostusedspacesbyageyear.php" class="button">Back</a>
        <head>
...
$query0 = "SELECT Space.space_id, COUNT(Visit.space_id) AS Freq, Space.space_name, Space.space_descr FROM Visit, Space, CustomerView WHERE CAST(Visit.entry_time as DATE)>'2019-12-30' AND Visit.nfc_id=CustomerView.nfc_id AND CustomerView.Age<41 AND Visit.space_id=Space.space_id GROUP BY Visit.space_id ORDER BY Freq DESC";
